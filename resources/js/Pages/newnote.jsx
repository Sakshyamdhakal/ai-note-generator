            ...
            <div className="w-full px-20">
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-2 gap-0 rounded-lg border border-[#262A31] overflow-hidden bg-[#0D0F12]">
                    ...
                    <div className="bg-[#151719] p-6 flex flex-col border-t md:border-t-0 border-[#262A31]">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            {generatedDoc && (
                                <button
                                    ...
                                    className="font-mono-note text-[10px] uppercase tracking-wider text-[#9A9DA6] hover:text-[#6FA8A0] transition-colors flex items-center gap-1 focus-visible:ring-1 focus-visible:ring-[#6FA8A0] rounded"
                                >
                                    <svg
                                        width="12"
                                        height="12"
                        ...
                        <div className="flex-1 overflow-y-auto min-h-[280px] font-serif-note text-[15px] leading-[1.8] text-[#E7E5E0]">
                            {generatedDoc ? (
